package com.step.toolkit.widgets
...
class VerifyButton(mContext: Context, attrs: AttributeSet) : Button(mContext, attrs) {
    ...
    private val countDown = object : Runnable {
        override fun run() {
            ...
            this@VerifyButton.setBackgroundColor(resources.getColor(R.color.colorAccent))
            this@VerifyButton.setTextColor(resources.getColor(R.color.colorAccent))
    ...
    fun resetCounter(vararg text: String) {
        ...
        this.setBackgroundColor(resources.getColor(R.color.colorAccent))
